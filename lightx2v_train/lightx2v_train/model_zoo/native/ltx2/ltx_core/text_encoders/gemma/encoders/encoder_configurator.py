...
def _resolve_local_base_freq(config: object) -> float:
    ...
    raise AttributeError("Gemma text_config exposes neither rope_local_base_freq nor rope_parameters['sliding_attention']['rope_theta']")
...
def _resolve_full_rope_type(config: object) -> str:
    ...
    if rope_scaling is not None:
        if isinstance(rope_scaling, dict):
            ...
            return str(rope_scaling.rope_type)
    raise AttributeError("Gemma text_config exposes neither rope_scaling.rope_type nor rope_parameters['full_attention']['rope_type']")
