...
lightx2v_path=/mnt/devsft_afs_1/gushiqiao/LightX2V
model_path=/models/seko_ar
...
--image_path "/mnt/devsft_afs_1/gushiqiao/1_素材图.png" \
--audio_path "/mnt/devsft_afs_1/gushiqiao/1_素材图.mp3" \
