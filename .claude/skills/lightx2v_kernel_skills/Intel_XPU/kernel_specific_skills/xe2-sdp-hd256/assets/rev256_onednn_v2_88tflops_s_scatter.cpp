...
#include "rev256_onednn_v2_88tflops_s_scatter.h" // v2 under test
...
int main() {
    ...
    std::cout << "================================================================\n";
    std::cout << "Variant: s_scatter (Approach 2: scatter write + block read)\n";
    std::cout << "================================================================\n";
    std::cout << "Device: " << q.get_device().get_info<sycl::info::device::name>() << "\n";
    std::cout << "Q Heads: " << NUM_Q_HEADS << ", KV Heads: " << NUM_KV_HEADS << ", Head Dim: 256\n\n";

    // ===== Section 1: Correctness =====
    std::cout << "--- Correctness (s_scatter vs CPU fp32 ref) ---\n";
    int pass = 0, total = 0;
    ...
    std::cout << "--- Performance (opt baseline vs s_scatter, 100 iters) ---\n";
